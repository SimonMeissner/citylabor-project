...
how_much_space_the_user_has <- 1000
clim <- "Cfa"
...
for(n in range){
  if(what_the_user_wants_to_plant == plants$plant_name[n]){
    #print(plants$name[n])
    #print(n)
    #print(plants$space[n])
    if(plants$required_space[n]>=how_much_space_the_user_has && plants$climate[n] == clim) {
